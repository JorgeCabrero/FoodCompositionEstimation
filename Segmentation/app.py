...
DEFAULT_IMAGE_PATH = "assets/test6.png"
DEFAULT_IMAGE_PATH_LIST = [
...
class_label_colormap = ["#C0C0C0", "#808080", "#000000", "#FF0000", "#800000",
...
modal_overlay = dbc.Modal(
    [
        ...
        dbc.ModalFooter(dbc.Button("Cerrar", id="howto-close", className="howto-bn")),
    ],
    id="modal",
    size="lg",
)
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.Img(
                            id="logo",
                            src=app.get_asset_url("buap-logo4.png"),
                            height="120px",
                        ),
                        md="auto",
                    ),
                    dbc.Col(
                        [
                            html.Div(
                                [
                                    html.H3("ML Image Segmentation"),
                                    html.P("Food Composition Estimation"),
                                ],
                                id="app-title",
                            )
                        ],
                    ...
                    [
                        dbc.Row(
                            [
                                ...
                                dbc.Col(
                                    html.P(
                                        "Este es un ejemplo de un clasificador interactivo de Machine Learning."
                                        " La aplicación clasifica los pixeles en la imagen en distintas clases."
                                        " Para entrenar el clasificador, dibuja marcas en la imagen con distintos colores"
                                        " en distintas áreas de la imagen, como en la imagen del ejemplo. Después activa la"
                                        'opción "Show Segmentation" para ver las clases que el clasificador de Random Forest'
                                        " dio a las distintas regiones de la imagen basado en la marcas proporcionadas por ti."
                                        " Puedes añadir más marcas para clarificar las partes en donde el clasificador no tuvo"
                                        " un resultado satisfactorio y a continuación la clasificación se actualizará"
...
segmentation = [
    dbc.Card(
        ...
        children=[
            dbc.CardHeader("Imagen de Platillo"),
            dbc.CardBody(
                [
...
def annotation_react(
    ...
    return (
        fig,
        masks_data,
        "Espesor del pincel: %d" % (stroke_width,),
